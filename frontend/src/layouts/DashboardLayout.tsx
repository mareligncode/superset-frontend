...
const DashboardLayout: React.FC<DashboardLayoutProps> = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 overflow-hidden w-full">
      {/* Premium Top Header */}
      <Header />
      ...
      <div className="flex flex-1 overflow-hidden w-full">
        ...
        <main
          className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar relative transition-all duration-300 w-full"
          style={{
            background:
              resolvedTheme === 'dark'
        ...
        >
          ...
          <div className="md:hidden p-3 sm:p-4 border-b-2 border-slate-200/60 dark:border-slate-700/60 bg-white/95 dark:bg-slate-800/95 backdrop-blur-xl shadow-sm w-full">
            <button
              onClick={() => setIsFilterPanelOpen(!isFilterPanelOpen)}
              className="flex items-center gap-2.5 text-[12px] sm:text-[13px] text-blue-700 dark:text-blue-400 font-extrabold bg-gradient-to-r from-blue-50 to-sky-50 dark:from-blue-950/30 dark:to-sky-950/30 px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-xl border-2 border-blue-200 dark:border-blue-700 hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-200 shadow-md hover:shadow-lg active:scale-95 min-h-[44px]"
